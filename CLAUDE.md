...
The npm package is `apollo-theme`; the repository remains `firefox-apollo-theme` at `https://github.com/apollo-theme/firefox-apollo-theme`. The display names are `Apollo Theme` and `Apollo Light Theme`.
